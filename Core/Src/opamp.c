...
void HAL_OPAMP_MspInit(OPAMP_HandleTypeDef* opampHandle)
{
  ...
  /* USER CODE END OPAMP1_MspInit 0 */
    ...
    PA7     ------> OPAMP1_VINP
    */
    GPIO_InitStruct.Pin = OA1_VA_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(OA1_VA_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END OPAMP2_MspInit 0 */
    ...
    PB0     ------> OPAMP2_VINP
    */
    GPIO_InitStruct.Pin = OA2_VB_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(OA2_VB_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END OPAMP6_MspInit 0 */
    ...
    PB13     ------> OPAMP6_VINP
    */
    GPIO_InitStruct.Pin = OA6_VIN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(OA6_VIN_GPIO_Port, &GPIO_InitStruct);
...
void HAL_OPAMP_MspDeInit(OPAMP_HandleTypeDef* opampHandle)
{
  ...
  /* USER CODE END OPAMP1_MspDeInit 0 */
    ...
    PA7     ------> OPAMP1_VINP
    */
    HAL_GPIO_DeInit(OA1_VA_GPIO_Port, OA1_VA_Pin);
  ...
  /* USER CODE END OPAMP2_MspDeInit 0 */
    ...
    PB0     ------> OPAMP2_VINP
    */
    HAL_GPIO_DeInit(OA2_VB_GPIO_Port, OA2_VB_Pin);
  ...
  /* USER CODE END OPAMP6_MspDeInit 0 */
    ...
    PB13     ------> OPAMP6_VINP
    */
    HAL_GPIO_DeInit(OA6_VIN_GPIO_Port, OA6_VIN_Pin);
